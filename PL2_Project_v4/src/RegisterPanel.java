...
public class RegisterPanel extends JPanel{
	...
	public RegisterPanel() {
		...
		createStudentIDComp();
		arrange();
		setBackground(Color.decode("#E4DAD2"));
	}
	...
	private void arrange() {
		...
		leftPanel.setBackground(Color.decode("#E4DAD2"));
		this.studentIDLabel.setPreferredSize(new Dimension(80, 20));
		this.studentIDLabel.setForeground(Color.decode("#454545"));
		this.studentIDTextField.setForeground(Color.decode("#454545"));
		this.majorLabel.setPreferredSize(new Dimension(80, 20));
		this.majorLabel.setForeground(Color.decode("#454545"));
		this.majorComboBox.setPreferredSize(new Dimension(133, 20));
		this.majorComboBox.setForeground(Color.decode("#454545"));
		...
		rightPanel.setBackground(Color.decode("#E4DAD2"));
		this.loginButton.setBounds(0, 5, 54, 55);
		loginButton.setForeground(Color.WHITE);
		loginButton.setBackground(Color.decode("#d5c6b9"));
		loginButton.setBorder(BorderFactory.createLineBorder(Color.decode("#d5c6b9"), 1, true));
