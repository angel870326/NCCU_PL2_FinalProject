...
public class FinishedCoursePanel extends JPanel {
	...
	private static final Color TITLE = Color.decode("#b2c3d1");  // #c2d0da
	private static final Color BACKGROUND = Color.decode("#E4DAD2");  // #E4DAD2
	private static final Color INNER = Color.decode("#E6EAED");  // #E6EAED
...
//							}
	...
	private void arrange(String currentCourseType) {
		...
		this.leftPanel.setBackground(BACKGROUND);
 		...
 		this.leftScrollPane.setBackground(BACKGROUND);
// 		this.leftScrollPane.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
 		this.leftScrollPane.setBorder(BorderFactory.createLineBorder(BACKGROUND, 1, true));
		for(int i = 0; i < this.semesterPanelList.size(); i++) {
			...
			this.semesterPanelList.get(i).setBackground(BACKGROUND);
//			this.semesterPanelList.get(i).setBorder(BorderFactory.createLineBorder(Color.BLACK, 1, true));
			...
			this.semesterLabelList.get(i).setBackground(TITLE);
			this.semesterLabelList.get(i).setBorder(BorderFactory.createLineBorder(TITLE, 1, true));
			this.semesterLabelList.get(i).setOpaque(true);
			this.leftCoursePanelList.get(i).setLayout(new WrapLayout(WrapLayout.LEFT));
			this.leftCoursePanelList.get(i).setBackground(INNER);
			...
			this.leftCourseScrollPaneList.get(i).setBackground(INNER);
			this.leftCourseScrollPaneList.get(i).setBorder(BorderFactory.createLineBorder(INNER, 1, true));
			this.saveBtnList.get(i).setPreferredSize(new Dimension(50, 20));
			this.saveBtnList.get(i).setForeground(Color.WHITE);
			this.saveBtnList.get(i).setBackground(TITLE);
			this.saveBtnList.get(i).setBorder(BorderFactory.createLineBorder(TITLE, 1, true));
			...
			this.updateBtnList.get(i).setBackground(TITLE);
			this.updateBtnList.get(i).setBorder(BorderFactory.createLineBorder(TITLE, 1, true));
		...
		this.rightPanel.setBorder(BorderFactory.createLineBorder(BACKGROUND, 1, true));
		for(int i = 0; i < this.coursePanelList.size(); i++) {
			...
			this.coursePanelList.get(i).setBackground(BACKGROUND);
//			this.coursePanelList.get(i).setBorder(BorderFactory.createLineBorder(Color.BLACK, 1, true));
			...
			this.courseTypeBtnList.get(i).setBackground(TITLE);
			this.courseTypeBtnList.get(i).setBorder(BorderFactory.createLineBorder(TITLE, 1, true));
			...
			this.rightCoursePanelList.get(i).setBackground(INNER);
			...
			this.rightCourseScrollPaneList.get(i).setBackground(INNER);
			this.rightCourseScrollPaneList.get(i).setBorder(BorderFactory.createLineBorder(INNER, 1, true));
...
//				this.generalComboBox.setBackground(new Color(55, 60, 85));
				...
				this.searchTextField.setBackground(INNER);
				this.searchTextField.setBorder(BorderFactory.createLineBorder(INNER, 1, true));
				this.searchBtn.setPreferredSize(new Dimension(50, 20));
				this.searchBtn.setForeground(Color.WHITE);
				this.searchBtn.setBackground(TITLE);
				this.searchBtn.setBorder(BorderFactory.createLineBorder(TITLE, 1, true));
		...
		this.nextBtn.setBackground(TITLE);
		this.nextBtn.setBorder(BorderFactory.createLineBorder(TITLE, 1, true));
